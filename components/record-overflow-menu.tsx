...
export function RecordOverflowMenu({ entity, id, href, label = "More actions" }: Props) {
  ...
  return (
    <div className="record-overflow" ref={ref}>
      <button
        type="button"
      ...
      {open && (
        <div className="record-overflow-menu" role="menu" onClick={(event) => event.stopPropagation()}>
          ...
          <button className="record-overflow-item" type="button" role="menuitem" disabled={busy !== null} onClick={() => run("archive")}>
            {busy === "archive" ? "Archiving…" : "Archive"}
          </button>
          <button
            className="record-overflow-item danger"
            type="button"
            role="menuitem"
            disabled={busy !== null}
            onClick={() => {
