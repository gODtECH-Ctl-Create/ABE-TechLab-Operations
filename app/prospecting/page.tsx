...
export default async function ProspectingPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <div className="page-shell">
      ...
      <div className="aria-research-context"><strong>ARIA Research</strong> uses a search-capable provider to discover public evidence, then stores prospects and sources in Operations for human review. Research does not contact anyone automatically.</div>
      ...
      <section className="research-layout">
        <div className="card research-builder"><div className="eyebrow">New research run</div><h2>Find potential customers</h2><p className="section-copy">Start narrow. Define the customer type, market and industries so the research worker has a precise target.</p><div className="inline-empty"><strong>Research engine paused</strong><span>Your request will be saved to the queue. AI provider execution can be enabled later without losing the request.</span><a href="/ai">View AI Control Centre →</a></div>
