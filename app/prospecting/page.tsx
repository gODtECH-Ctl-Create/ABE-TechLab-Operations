  ...
  return (
    <div className="page-shell">
      ...
      <section className="research-layout">
        <div className="card research-builder"><div className="eyebrow">New research run</div><h2>Find potential customers</h2><p className="section-copy">Start narrow. Define the customer type, market and industries so the eventual research worker has a precise target.</p>
          <form action={createResearchRequest} className="research-form"><label>What are we looking for?<textarea name="query" required placeholder="Nigerian organisations that need product strategy, software development or AI automation." /></label><div className="research-form-grid"><label>Geography<input name="geography" defaultValue="Nigeria" /></label><label>Industries<input name="industries" placeholder="Education, FinTech, Healthcare" /></label></div><div className="research-checks"><span>ARIA will preserve:</span><span>✓ request</span><span>✓ qualification context</span><span>✓ audit event</span><span>✓ approval boundary</span></div><button className="primary-button" type="submit">Queue research run →</button></form>
        </div>
