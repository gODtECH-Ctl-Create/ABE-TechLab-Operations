...
export function AriaBriefing({ initialRuns, canPropose, view = "overview" }: { initialRuns: RecentRun[]; canPropose: boolean; view?: "overview" | "conversation" | "activity" }) {
