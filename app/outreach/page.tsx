...
export default async function OutreachPage({ searchParams }: Props) {
  ...
  return <main className="page-shell">
    ...
    <OutreachNavigation active="Campaigns" />
