  ...
  return (
    <main className="site-loading" aria-live="polite" role="status">
      ...
      <style>{`
        ...
        .site-loading-logo{position:relative;z-index:1;width:68px;height:68px;display:grid;place-items:center;border-radius:20px;overflow:hidden;box-shadow:0 18px 42px rgba(17,17,15,.14);animation:abe-loader-logo 1.8s ease-in-out infinite}
        .site-loading-logo img{display:block;width:100%;height:100%}
        ...
        @media (max-width:700px){.site-loading-mark{width:92px;height:92px}.site-loading-logo{width:62px;height:62px}.site-loading-ring-two{inset:8px}}
